...
public class ResourceEndpoints : EndpointGroup
{
    ...
    (RequestContext context, IDataStore dataStore, GameDatabaseContext database, GameUser? user, string levelId,
        string versionId, string file)
    {
    ...
    [GameEndpoint("~news:{id}/~content:thumbnail/data.get")]
    [Authentication(false)]
    public Response GetNewsThumbnail(RequestContext context, GameDatabaseContext database, IDataStore dataStore,
        string id)
    {
    ...
    [Authentication(false)]
    public Response GetCommunityTabThumbnail(RequestContext context, IDataStore dataStore, GameDatabaseContext database,
        string id)
    {
